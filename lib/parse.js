...
define(['esprima', './lang'], function (esprima, lang) {
     ...
     * have not been normalized, they may be relative IDs. Formal parameter
     * names of the dependencies, which were used in the factory callback,
     * are stored as "params" property on the array instance.
     */
     ...
     *
     * @returns {Object} Start and end location of the found identifier
     *  in the specified text.
     */
    parse.findIdentifier = function (fileName, fileContents, identifier) {
		var astRoot = typeof fileContents === 'string' ?
